...
Zuul repositories can be trusted and untrusted [[1]](#f1). Patches submitted to
trusted repository can not be tested prior to merge because of security context.
